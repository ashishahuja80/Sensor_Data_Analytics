...
INPUT_PROJECT_INPUT_TXT_FILE = "PL1029_Plock.txt"
...
for (i in 1:INPUT_MY_NUMBER_OF_INPUTS)
{
  ...
  my_for_eval_MY_INPUT_VECTOR  = paste('MY_INPUT_VECTOR_V', i, '= ' , '\"', "V", i+2, '\"', sep="")
  eval(parse(text=my_for_eval_MY_INPUT_VECTOR))
  
  
  my_for_eval_MY_INPUT_VECTOR  = paste('MY_INPUT_VECTOR_UNIT_V', i, '= ' , '\"', '\"', sep="")
  eval(parse(text=my_for_eval_MY_INPUT_VECTOR))
